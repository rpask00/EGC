...
export const slide = trigger('routeAnimations', [
  transition(
    `home => news, home => contact, home => about,home => schedule, home => gallery, news => contact,news => about, news => schedule, news => gallery, contact => about, contact => schedule, contact => gallery, about => schedule, about => gallery, schedule => gallery`,
    [
      query(':enter, :leave', [
        style({
          position: 'absolute',
  ...
  transition(
    `gallery => schedule, gallery => about, gallery => contact, gallery => news, landscape => gallery, landscape => schedule, landscape => about, landscape => contact, landscape => news, schedule => about, schedule => contact, schedule => news, about => contact, about => news, contact => news`,
    [
      query(':enter, :leave', [
        style({
          position: 'absolute',
